return {
  ...
  config = function()
    ...
    local kind_icons = {
      Text = ki.text,
      Method = ki.Method,
      Function = ki.Function,
      Constructor = ki.Constructor,
      Field = ki.Field,
      Variable = ki.Variable,
      Class = ki.Class,
      Interface = ki.Interface,
      Module = ki.Module,
      ...
      Folder = ki.Folder,
      EnumMember = ki.EnumMember,
      Constant = ki.Constant,
      Struct = ki.Struct,
      Event = ki.Event,
      Operator = ki.Operator,
      TypeParameter = ki.TypeParameter,
      Version = ki.Version,
      Feature = ki.Feature,
    }
