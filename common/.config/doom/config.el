...
(custom-set-faces!
  ...
  '(font-lock-comment-face :family "Monaspace Radon" :slant italic)
  '(font-lock-keyword-face :family "Monaspace Radon" :slant italic)
  '(org-italic :family "Monaspace Radon" :slant italic))
;;
